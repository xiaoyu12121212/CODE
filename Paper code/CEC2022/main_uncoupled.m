...
for i = 1: 30
    ...
    [Bestscore2, Best_pos2, curve2] = unc_ZOA(npop, Max_iter, lb, ub, dim, fobj, 1, 4, theta);
    [Bestscore3, Best_pos3, curve3] = unc_ZOA(npop, Max_iter, lb, ub, dim, fobj, 2, 3, theta);
    [Bestscore4, Best_pos4, curve4] = unc_ZOA(npop, Max_iter, lb, ub, dim, fobj, 2, 4, theta);
    [Bestscore5, Best_pos5, curve5] = unc_ZOA(npop, Max_iter, lb, ub, dim, fobj, 2, 4, rho);
    [Bestscore6, Best_pos6, curve6] = unc_ZOA(npop, Max_iter, lb, ub, dim, fobj, 3, 3, rho);
    [Bestscore7, Best_pos7, curve7] = unc_ZOA(npop, Max_iter, lb, ub, dim, fobj, 3, 4, rho);
...
legend('ZOA', 'ZOA1-4theta', 'ZOA2-3theta', 'ZOA2-4theta', 'ZOA2-4rho', 'ZOA3-3rho', 'ZOA3-4rho')
set(gca, 'FontSize', 18);
